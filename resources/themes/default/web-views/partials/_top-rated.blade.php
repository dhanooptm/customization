                            ...
                            <a class="__best-selling" href="{{route('product',$top->product->slug)}}">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div class="top-rated-details">
                                        ...
                                        @endif
                                        @if ($top->product->price_type == "single_price")
                                        <div class="justify-content-between text-center">
                                           ...
                                           <span class="text-center flex-wrap">
                                            {{ translate('Min. order:') }}  {{ $top->product->minimum_order_qty .' ' . $top->product->unit }}
                                         </span>
                                        </div>
                                        @endif
                                        @if ($top->product->price_type == "multiple_price" && json_decode($top->product->product_multi_price,true))
                                        @php($product_multi_price = json_decode($top->product->product_multi_price,true))
                                        <div class="justify-content-between text-center">
                                            <div class="product-price text-center d-flex flex-wrap justify-content-center align-items-center gap-8">
                                            ...
                                            @endif
                                                <span class="text-accent text-dark flex-wrap">
                                                    {{ webCurrencyConverter(amount:
                                                        $product_multi_price[0]['price']-(getProductDiscount(product: $top->product, price: $product_multi_price[0]['price']))
                                                    ) }}
                                                </span>
                                            </div>
                                            <span class="text-center flex-wrap">
                                        ...
                                        @endif
                                        @if ($top->product->price_type == 'priceless')
                                        {{-- <button id="requestPriceButtonTopRated-{{ $product->id }}" class="btn btn--primary btn-sm">
                                            Price Request
                                        </button> --}}
                                        <span class="text-center flex-wrap">
...
document.addEventListener('DOMContentLoaded', function () {
    const buttonId = "requestPriceButtonTopRated-" + "{{ $product->id }}";
