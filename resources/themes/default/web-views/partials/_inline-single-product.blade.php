...
<div class="product-single-hover style--card">
    <div class="overflow-hidden position-relative">
        ...
        <div class="single-product-details">
            ...
            @endif
            <div class="text-center text-capitalize fw-semibold">
            ...
            <div class="justify-content-between text-center">
                <div class="product-price text-center d-flex flex-wrap justify-content-center align-items-center gap-8">
                    {{-- <button id="requestPriceButtonInlineSingle-{{ $product->id }}" class="text-center btn btn--primary btn-sm">
                        Price Request
                    </button> --}}
                    <span class="text-center flex-wrap">
...
document.addEventListener('DOMContentLoaded', function () {
    const buttonId = "requestPriceButtonInlineSingle-" + "{{ $product->id }}";
