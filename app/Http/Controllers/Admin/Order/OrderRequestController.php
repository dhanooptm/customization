...
class OrderRequestController extends Controller
{
    public function index(Request $request)
    {
        ...
        $orders = OrderRequest::with(['product','customer','seller'])->latest()
        ...
        return view('admin-views.order.order-request.list',compact('orders','status'));
    ...
    public function details(Request $request, $id)
    {
        ...
        if (isset($order)) {
            return view('admin-views.order.order-request.order-details', compact('order'));
        } else {
