                                ...
                                <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table w-100 text-start">
                                    ...
                                    @foreach($orders as $key=>$order)
                                        ...
                                        <tr class="status-{{$order['order_status']}} class-all">
                                            ...
                                            <td >
                                                <a class="title-color" href="{{route('vendor.orders.order-request.details',['id'=>$order['id']])}}">{{$order['id']}} {!! $order->order_type == 'POS' ? '<span class="text--primary">(POS)</span>' : '' !!}</a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                    ...
                                                    @if($order->customer)
                                                        <a class="text-body text-capitalize" href="{{route('vendor.orders.order-request.details',['id'=>$order['id']])}}">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a class="btn btn-outline--primary square-btn btn-sm mr-1" title="{{translate('view')}}"
                                                        href="{{route('vendor.orders.order-request.details',['id'=>$order['id']])}}">
