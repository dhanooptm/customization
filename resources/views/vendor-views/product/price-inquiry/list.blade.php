                                    ...
                                    <div class="form-group">
                                        <select class="js-select2-custom form-control" name="status" onchange="statusCheck(this.value)"
                                            ...
                                            <option value="{{ old('product_id') }}" selected
                                                    ...
                                                    <option  {{ $status == "all" ? 'selected' : '' }}>{{ translate('All') }}</option>
                                ...
                                @foreach($products as $key => $brand)
                                    <tr>
                                        ...
                                        <td class="text-start text-wrap">
                                            {{ Str::limit($brand['descriptions'], 20) }}
                                            @if(Str::length($brand['descriptions']) > 20)
                                        ...
                                        <td>
                                            <form action="{{route('vendor.products.inquiry.price-status-update') }}" method="post" id="inquiry-status{{$brand['id']}}-form">
                                                @csrf
                                        ...
                                        <td>
                                            ...
                                            <form action="{{route('vendor.products.inquiry.price-delete',[$brand['id']])}}"
...
<script>
  ...
  location.href = "{{ route('vendor.products.inquiry.request-list')}}" +'?status=' + status;
    }
