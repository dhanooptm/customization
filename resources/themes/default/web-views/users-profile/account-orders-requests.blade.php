...
@section('title', translate('my_Order_Request_List'))
                ...
                <div class="card __card d-none d-lg-flex web-direction customer-profile-orders h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between gap-2 mb-0 mb-md-3">
                            <h5 class="font-bold mb-0 fs-16">{{ translate('my_Order_Requests') }}</h5>
                        </div>
                                    ...
                                    <tr>
                                        <td class="bodytr">
                                            <div class="media-order">
                                                <a href="{{ route('account-request-order-details', ['id'=>$order->id]) }}" class="d-block position-relative">
                                                ...
                                                <h6 class="font-weight-bold m-0 mb-1">
                                                    <a href="{{ route('account-request-order-details', ['id'=>$order->id]) }}"
                        ...
                        @else
                            <div class="d-flex justify-content-center align-items-center h-100">
                                <div class="d-flex flex-column justify-content-center align-items-center gap-3">
                                    ...
                                    <h5 class="text-muted fs-14 font-semi-bold text-center">{{ translate('You_have_not_any_order_request_yet') }}!</h5>
                                </div>
                            </div>
                        @endif
                                    ...
                                    <div class="media-order">
                                        ...
                                        <div class="cont text-start">
                                            <h6 class="font-weight-bold mb-1 fs-14">
                                                <a class="fs-12 font-semibold" href="{{ route('account-request-order-details', ['id'=>$order->id]) }}">
                                                    {{ translate('order') }} #{{$order['id']}}
                                                </a>
                                            </h6>
