...
return [
	...
	"price_range_add" => "Price range add",
	"image_alt_text" => "Image alt text",
	"messages.endless" => "Messages.endless",
	"end_point" => "End point",
	...
	"Product_Price_Setup" => "Product Price Setup",
	"is_endless" => "Is endless",
	"Price range added successfully" => "Price range added successfully",
	"messages.Yes" => "Messages.Yes",
	"messages.brand" => "Messages.brand",
	"messages.no" => "Messages.no",
	"Are you sure?" => "Are you sure ",
	"Want to delete this item ?" => "Want to delete this item  ",
	"Want to delete this range ?" => "Want to delete this range  ",
	"endless already checked" => "Endless already checked",
	"Price range deleted successfully" => "Price range deleted successfully",
	"price range overlaped" => "Price range overlaped",
	"brand_Update" => "Brand Update",
	"use_this_product_info" => "Use this product info",
	"messages.delivery_range_mapping" => "Messages.delivery range mapping",
	...
	"product_price_inquiry" => "Product price inquiry",
	"product_inquiry_List" => "Product inquiry List",
	"descriptions" => "Descriptions",
	"completed_inquiry" => "Completed inquiry",
	"pending_inquiry" => "Pending inquiry",
	"Want to delete this inquiry ?" => "Want to delete this inquiry  ",
	"Product inquiry deleted successfully" => "Product inquiry deleted successfully",
	"request_price" => "Request price",
	"product_price_inquiry_List" => "Product price inquiry List",
	"similar_info" => "Similar info",
	"dealer" => "Dealer",
	"add_new_price" => "Add new price",
	"sdvfvsfd" => "Sdvfvsfd",
	"contact_supplier" => "Contact supplier",
	"Price_Request" => "Price Request",
	"contact_supplier1" => "Contact supplier1",
	"contact_supplier_guest" => "Contact supplier guest",
	"Write_Here" => "Write Here",
	"Describe your sourcing requirments for products" => "Describe your sourcing requirments for products",
	"Describe_your_sourcing_requirments_for_products" => "Describe your sourcing requirments for products",
	"Product Inquiry added successfully" => "Product Inquiry added successfully",
	"i_am_a_dealer" => "I am a dealer",
	"receive_offers_for_similar_products" => "Receive offers for similar products",
	"Product Price Inquiry added successfully" => "Product Price Inquiry added successfully",
	"product_Inquiry_added_successfully" => "Product Inquiry added successfully",
	"product_price_inquiry_added_successfully" => "Product price inquiry added successfully",
	"Invalid data format for product_multi_price" => "Invalid data format for product multi price",
	"discount_is_greater_than_price" => "Discount is greater than price",
	"pin" => "Pin",
	"invalid_credential" => "Invalid credential",
	"start_order_request" => "Start order request",
	"pieces" => "Pieces",
	...
	"complete_order_request" => "Complete order request",
	...
	"order_request_send_successfully" => "Order request send successfully",
	...
	"product_information" => "Product information",
	"order_Request_Details" => "Order Request Details",
	"Order_Request_ID" => "Order Request ID",
	"order_Request_ID" => "Order Request ID",
	"variation_price" => "Variation price",
	"read_status" => "Read status",
	"change_read_status" => "Change read status",
	"Are_you_want_to_change_read_status?" => "Are you want to change read status ",
	"view_More" => "View More",
	...
	"search_by_contact_info" => "Search by contact info",
	"No price range available. Please increase or decrease the quantity to fit within an available range" => "No price range available. Please increase or decrease the quantity to fit within an available range",
	"Order_Placed_Successfully" => "Order Placed Successfully",
	"Order_Request_Sent_Successfully" => "Order Request Sent Successfully",
	"your_order_request_has_been_successfully_processed_and_your_order" => "Your order request has been successfully processed and your order",
	"my_request_order" => "My request order",
	"my_Order_Request_List" => "My Order Request List",
	"my_Order_Requests" => "My Order Requests",
	"You_have_not_any_order_yet" => "You have not any order yet",
	"invalid_order" => "Invalid order",
	"marked_as_read" => "Marked as read?",
	"marked_as_unread" => "Marked as unread?",
	"search_by_contact" => "Search by contact",
	...
	"Order_Request_LIST" => "Order Request LIST",
	"Order_Request_List" => "Order Request List",
	"See_Order_Request" => "See Order Request",
	"reward_by_company_admin" => "Reward by company admin",
	"transaction_Id" => "Transaction Id",
	"reset_Password" => "Reset Password",
	"meanwhile_click_here_to_visit_" => "Meanwhile click here to visit ",
	"_website" => " website",
	"contact_supllier" => "Contact supllier",
	"my_Order_Request" => "My Order Request",
	"your_Name" => "Your Name",
	"your_E_-_mail" => "Your E - mail",
	"contact_Number" => "Contact Number",
