                            ...
                            <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table w-100 text-start">
                                ...
                                @foreach($products as $key => $brand)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{route('admin.products.inquiry.status-update') }}" method="post" id="inquiry-status{{$brand['id']}}-form">
                                                @csrf
                                        ...
                                        <td>
                                            ...
                                            {{-- <form action="{{route('admin.products.inquiry.delete',[$brand['id']])}}"
