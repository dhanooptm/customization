...
@section('content')
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="media align-items-center gap-10">
                                                    <a href="{{ route('vendor.products.view',['addedBy'=>($order->product['added_by']=='seller'?'vendor' : 'in-house'),'id'=>$order->product['id']]) }}"><img class="avatar avatar-60 rounded img-fit"
                                                        src="{{ getStorageImages(path:$order?->product?->thumbnail_full_url, type: 'backend-product') }}"
                                                        alt="{{translate('image_Description')}}"></a>
                                                    <div>
                                                        <a href="{{ route('vendor.products.view',['addedBy'=>($order->product['added_by']=='seller'?'vendor' : 'in-house'),'id'=>$order->product['id']]) }}">
    ...
    <span id="read-status-url" data-url="{{ route('vendor.orders.order-request.read-status') }}"></span>
