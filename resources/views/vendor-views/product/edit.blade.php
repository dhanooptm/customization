...
<script>
    $(document).ready(function() {
                ...
                <div class="price-field row">
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="start-point form-control" oninput="this.value = Math.floor(this.value)" min="${startMin}" value="${startPoint}" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="end-point form-control" oninput="this.value = Math.floor(this.value)" value="${endPoint}" />
                        </div>
                    </div>
        ...
        function fetchData() {
            $.ajax({
                url: "{{route('vendor.products.get-price-range',['id'=>$product->id])}}",
                method: 'GET',
                dataType: 'json',
